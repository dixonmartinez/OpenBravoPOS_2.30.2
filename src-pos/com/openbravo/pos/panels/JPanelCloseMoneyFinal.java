...
public class JPanelCloseMoneyFinal extends JPanel implements JPanelView, BeanFactoryApp {
    ...
    private void compararValores() {
        ...
        modeltbl.addColumn("Dinero Registrado");
        modeltbl.addColumn("Diferencia");
   ...
   public class ModelDifference extends DefaultTableModel{
    ...
    private class FormatsPayment extends Formats {
        protected String formatValueInt(Object value) {
            System.out.println("transpayment." + (String) value);
    ...
    private void initComponents() {
        ...
        tblDifference = new javax.swing.JTable();
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("label.differenceDetail"))); // NOI18N

        m_jScrollTableTicket1.setFocusable(false);
        m_jScrollTableTicket1.setMinimumSize(new java.awt.Dimension(350, 140));
        m_jScrollTableTicket1.setPreferredSize(new java.awt.Dimension(450, 140));

        tblDifference.setFocusable(false);
        m_jScrollTableTicket1.setViewportView(tblDifference);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(m_jScrollTableTicket1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
        );
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(m_jScrollTableTicket1, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    public void closeCash(){
            ...
            try {               
                ...
                if (m_App.getActiveCashDateEnd() == null) {
                    Locale lc_ve = new Locale("es", "VE");
                    Double d = 0.00;
                    NumberFormat numberFormatVE = NumberFormat.getCurrencyInstance(lc_ve);
                    try {
                        d = numberFormatVE.parse(m_jDifference.getText()).doubleValue();
                    ...
                    new StaticSentence(m_App.getSession()
                        , "UPDATE CLOSEDCASH SET DATEEND = ?, DIFFERENCE = ? WHERE PERSON = ? AND MONEY = ?"
                        , new SerializerWriteBasic(new Datas[] {Datas.TIMESTAMP, Datas.DOUBLE, Datas.STRING, Datas.STRING}))
            ...
            try {
                ...
                if (m_UserID == userID)
                    m_dlSystem.execInsertCash(
                            new Object[] {userID, m_App.getActiveCashSequence(), m_App.getActiveCashDateStart(), m_App.getActiveCashDateEnd(), m_UserID});
