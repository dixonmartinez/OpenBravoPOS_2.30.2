...
public class JPanelSQL  extends JPanel implements JPanelView {
    ...
    private void initComponents() {
        ...
        m_jForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/1rightarrow.png"))); // NOI18N
        ...
        add(m_jForward);
        m_jForward.setBounds(70, 10, 50, 26);

        m_jBack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/1leftarrow.png"))); // NOI18N
        ...
        add(m_jBack);
        m_jBack.setBounds(10, 10, 50, 26);
        add(m_TabbedPane);
        m_TabbedPane.setBounds(10, 130, 510, 200);

        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/editnew.png"))); // NOI18N
        ...
        add(jButton2);
        jButton2.setBounds(10, 100, 50, 26);

        m_jtabdelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/editdelete.png"))); // NOI18N
        ...
        add(m_jtabdelete);
        m_jtabdelete.setBounds(70, 100, 50, 26);
        ...
        add(m_jbegintrans);
        m_jbegintrans.setBounds(150, 10, 90, 25);
        ...
        add(m_jcommit);
        m_jcommit.setBounds(250, 10, 84, 25);
        ...
        add(m_jrollback);
        m_jrollback.setBounds(350, 10, 90, 25);
