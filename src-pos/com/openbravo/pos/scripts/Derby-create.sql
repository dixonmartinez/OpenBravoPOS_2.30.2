...
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE, SUPERVISOR) VALUES ('0', 'Administrador', NULL, '0', 1, NULL, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE, SUPERVISOR) VALUES ('1', 'Gerente', NULL, '1', 1, NULL, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE, SUPERVISOR) VALUES ('2', 'Empleado', NULL, '2', 1, NULL, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE, SUPERVISOR) VALUES ('3', 'Invitado', NULL, '3', 1, NULL, NULL);
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('000', 'Impuesto Excento', '000', NULL, NULL, 0, 0, NULL);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', 'Impuesto Estándar', '001', NULL, NULL, 0.10, 0, NULL);
...
CREATE TABLE CLOSEDCASH (
    ...
    DIFFERENCECASH DOUBLE PRECISION DEFAULT 0,
    DIFFERENCEDOLLAR DOUBLE PRECISION DEFAULT 0,
    PRIMARY KEY(MONEY),
...
CREATE TABLE TICKETS (
    ...
    ISDOLLARCASH SMALLINT DEFAULT 0 NOT NULL,
    ORDERNUMBER INTEGER ,
    PRIMARY KEY (ID),
