...
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE, SUPERVISOR) VALUES ('0', 'Administrador', NULL, '0', TRUE, NULL, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE, SUPERVISOR) VALUES ('1', 'Gerente', NULL, '1', TRUE, NULL, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE, SUPERVISOR) VALUES ('2', 'Empleado', NULL, '2', TRUE, NULL, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE, SUPERVISOR) VALUES ('3', 'Invitado', NULL, '3', TRUE, NULL, NULL);
...
CREATE TABLE CLOSEDCASH (
    ...
    DIFFERENCECASH DOUBLE DEFAULT 0,
    DIFFERENCEDOLLAR DOUBLE DEFAULT 0,
    PRIMARY KEY(MONEY),
...
CREATE TABLE CLOSEDCASHLINES (
    ...
    POINTOFSALES VARCHAR(256) NOT NULL,
...
CREATE TABLE TICKETS (
    ...
    ISDOLLARCASH INTEGER DEFAULT 0 NOT NULL,
    ORDERNUMBER INTEGER ,
    PRIMARY KEY (ID),
...
CREATE TABLE CONVERSIONRATE(
    CONVERSIONRATE_ID  VARCHAR(255) NOT NULL,
    CURRENCY_ID  VARCHAR(255) NOT NULL,
    CURRENCYTO_ID  VARCHAR(255) NOT NULL,
    DIVIDERATE DOUBLE NOT NULL,
    ISACTIVE VARCHAR(1) DEFAULT 'Y',
    MULTIPLYRATE DOUBLE NOT NULL,
    VALIDFROM TIMESTAMP DEFAULT '2015-01-01 00:00:00' NOT NULL,
    VALIDTO TIMESTAMP,
    PRIMARY KEY (CONVERSIONRATE_ID),
    CHECK (ISACTIVE IN ('Y','N'))
)ENGINE=InnoDB DEFAULT CHARSET=utf8;


INSERT INTO CONVERSIONRATE (CONVERSIONRATE_ID,CURRENCY_ID,CURRENCYTO_ID,DIVIDERATE,ISACTIVE,MULTIPLYRATE,VALIDFROM,VALIDTO)
VALUES ('f590bfc4-084b-4b6b-b593-70ac84ef4a03','MXN','USD',21.589,'Y',0.046,'2017-01-22 12:00:00',null);

INSERT INTO CONVERSIONRATE (CONVERSIONRATE_ID,CURRENCY_ID,CURRENCYTO_ID,DIVIDERATE,ISACTIVE,MULTIPLYRATE,VALIDFROM,VALIDTO)
VALUES ('39587d67-6a04-40c9-804c-f31715ad16f2','USD','MXN',0.0463201,'Y',21.589,'2017-01-01 12:00:00',null);
